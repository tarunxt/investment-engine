Warning: truncated output (original token count: 35567)
...
quantity continues to count aga…5567 tokens truncated…s and scheduler-state rows plus a narrow indexed identity/status
