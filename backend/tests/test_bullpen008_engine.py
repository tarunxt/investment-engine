...
def test_optimizer_freezes_expired_nonclaimable_holdings_until_resolution() -> None:
    ...
    result = build_portfolio_target(
        [row], settings=Bullpen008Settings(), available_cash_usd=50, inputs_hash="expired"
    )
