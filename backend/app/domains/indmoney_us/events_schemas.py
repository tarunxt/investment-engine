...
class IndMoneyUsEventsAnalysisResponse(BaseModel):
    job_id: int
    status: JobStatus
    provider: str
    model: str
...
class IndMoneyUsEventsLatestResponse(BaseModel):
    analysis: IndMoneyUsEventsAnalysisResponse | None = None


class IndMoneyUsEventsHistoryResponse(BaseModel):
    history: list[PortfolioAnalysisHistoryItemResponse]


class IndMoneyUsEventsRunResponse(BaseModel):
    job_id: int
    status: JobStatus
    provider: str
    model: str
