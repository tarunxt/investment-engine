...
Formatting Rules:
- Rationale Score rule: whenever any Score Rationale / rationale-score column is requested, return only one of these 7 integer choices: -3 (minus three)=very bearish, -2 (minus two)=bearish, -1 (minus one)=slightly bearish, 0=neutral, 1=slightly bullish, 2=bullish, 3=very bullish. Do not return decimals, ranges, percentages, words, or values outside these integers. Each rationale score must justify its adjacent rationale.
