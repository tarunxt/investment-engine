...
Formatting Rules:
- Score columns must be one of -3, -2, -1, 0, 1, 2, 3 only, where -3=very bearish, -2=bearish, -1=slightly bearish, 0=neutral, 1=slightly bullish, 2=bullish, 3=very bullish. Each score must justify its adjacent rationale.
